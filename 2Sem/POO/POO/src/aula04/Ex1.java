...
public class Ex1 {
    ...
    private static void criarCir(Circulo c, Scanner sc) {
        do {
                ...
                if (c.Valid()) {
                    break;
                } else System.out.println("Não inseriu um valor positivo");
        }while(true);
    }
    ...
    private static void criarRetangulo(Retangulo r, Scanner sc) {
        do {
            ...
            if (r.Valid()) {
                break;
            } else System.out.println("Não inseriu parâmetros positivos.");
        }while(true);
    }
    ...
    private static void criarTriangulo(Triangulo t, Scanner sc) {
        do {
            ...
            if (t.Valid()) {
                break;
            } else System.out.println("Só são aceites valores positivos e que respeitem a Desigualdade Triangular.");           
        }while(true);
    }
}
